...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Happy", font=("sans-serif", 25, "bold"))
    my_turtle_cursor.getscreen().update()
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Birthday", font=("sans-serif", 25, "bold"))
    my_turtle_cursor.getscreen().update()

def write_toyou_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    my_turtle_cursor.color(text_color)
    my_turtle_cursor.goto(x, y)
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Wahyu", font=("sans-serif", 25, "bold"))
    my_turtle_cursor.getscreen().update()
...
write_happy_inside_circle("#000000", -50, y_coordinate + 255)
write_birthday_inside_circle("#000000", -65, y_coordinate + 215)
write_toyou_inside_circle("#000000", -54, y_coordinate + 175)
